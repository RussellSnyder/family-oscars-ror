...
class NominationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nomination" do
    assert_difference('Nomination.count') do
      post nominations_url, params: { nomination: { description: @nomination.description, name: @nomination.name, vote_count: @nomination.vote_count } }
    end
  ...
  test "should update nomination" do
    patch nomination_url(@nomination), params: { nomination: { description: @nomination.description, name: @nomination.name, vote_count: @nomination.vote_count } }
